package com.terminus.yttutorial.circleindicator;
...
import com.terminus.yttutorial.circleindicator.Config;
...
class BaseCircleIndicator extends LinearLayout {
    ...
    @Nullable
    private BaseCircleIndicator.IndicatorCreatedListener mIndicatorCreatedListener;
    ...
    private Config handleTypedArray(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray =
                context.obtainStyledAttributes(attrs, com.terminus.yttutorial.R.styleable.BaseCircleIndicator);
        config.width =
                typedArray.getDimensionPixelSize(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_width, -1);
        config.height =
                typedArray.getDimensionPixelSize(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_height, -1);
        config.margin =
                typedArray.getDimensionPixelSize(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_margin, -1);
        config.animatorResId = typedArray.getResourceId(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_animator,
                com.terminus.yttutorial.R.animator.scale_with_alpha);
        config.animatorReverseResId =
                typedArray.getResourceId(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_animator_reverse, 0);
        config.backgroundResId =
                typedArray.getResourceId(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_drawable,
                        com.terminus.yttutorial.R.drawable.white_radius);
        config.unselectedBackgroundId =
                typedArray.getResourceId(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_drawable_unselected,
                        config.backgroundResId);
        config.orientation = typedArray.getInt(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_orientation, -1);
        config.gravity = typedArray.getInt(com.terminus.yttutorial.R.styleable.BaseCircleIndicator_ci_gravity, -1);
        typedArray.recycle();
    ...
    public void initialize(Config config) {
        ...
        mIndicatorBackgroundResId =
                (config.backgroundResId == 0) ? com.terminus.yttutorial.R.drawable.white_radius : config.backgroundResId;
    ...
    public void setIndicatorCreatedListener(
            @Nullable BaseCircleIndicator.IndicatorCreatedListener indicatorCreatedListener) {
    ...
    protected Animator createAnimatorIn(Config config) {
        ...
        if (config.animatorReverseResId == 0) {
            ...
            animatorIn.setInterpolator(new BaseCircleIndicator.ReverseInterpolator());
        } else {
